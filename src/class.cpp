...
byte saving_throws(int class_num, int type, int level)
{
    ...
    default:
        WriteLogf("SYSERR: Invalid class saving throw.");
        break;
    }
...
int thaco(int class_num, int level)
{
    ...
    default:
        WriteLogf("SYSERR: Unknown class in thac0 chart.");
    }
...
int level_exp(int chclass, int level)
{
    ...
    // incomplete.
    WriteLogf("SYSERR: XP tables not set up correctly in class.c!");
    return 123456;
}
